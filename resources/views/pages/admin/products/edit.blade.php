                            ...
                            <div class="card-body">
                                <form action="{{ route('product.update', $item->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="userProduct">Pemilik Product</label>
                                                <select name="users_id" id="userProduct" class="form-control" required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="categoryProduct">Kategori Product</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="priceProduct">Harga Product</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="descriptionProduct">Deskripsi Product</label>
